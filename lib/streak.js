...
/**
 * activityDates: array of "YYYY-MM-DD" strings, any order, duplicates fine.
 * Returns the longest run of consecutive calendar days anywhere in the
 * user's history, not just the one touching today - a broken streak still
 * has a "personal best" worth remembering. Returns 0 for no activity.
 */
export function computeLongestStreak(activityDates) {
